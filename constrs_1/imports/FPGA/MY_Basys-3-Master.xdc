...
# set_property -dict { PACKAGE_PIN J1  IOSTANDARD LVCMOS33 } [get_ports { o_motorState }]; #IO_L3N_T0_DQS_AD5N_35 ,Sch=JA1
...
set_property -dict { PACKAGE_PIN A14  IOSTANDARD LVCMOS33 } [get_ports { o_motorState }]; #IO_L6P_T0_16       ,Sch=JB1
